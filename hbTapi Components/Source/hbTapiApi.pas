...
{$HPPEMIT '// source file before you include hbTapiApi.h:'}
{$HPPEMIT '//'}
...
{$IFDEF TAPI20}
  ...
  phonemessage_tag = linemessage_tag;
...
function lineOpenA(hLineApp: HLINEAPP; dwDeviceID: DWORD; lphLine: PHLine;
  dwAPIVersion, dwExtVersion : DWORD; dwCallbackInstance: DWORD_PTR; dwPrivileges,
...
function phoneOpen(hPhoneApp: HPHONEAPP; dwDeviceID: DWORD; var hPhone: HPHONE;
  dwAPIVersion, dwExtVersion: DWORD; dwCallbackInstance : DWORD_PTR;
...
function lineAddProvider; external TapiDll name 'lineAddProvider'+CODE_SUFFIX;
{$ELSE}
...
function lineBlindTransfer; external TapiDll name 'lineBlindTransfer'+CODE_SUFFIX;
{$ELSE}
...
function lineConfigDialog; external TapiDll name 'lineConfigDialog'+CODE_SUFFIX;
{$ELSE}
...
function lineConfigDialogEdit; external TapiDll name 'lineConfigDialogEdit'+CODE_SUFFIX;
{$ELSE}
...
function lineCreateAgent; external TapiDll name 'lineCreateAgent'+CODE_SUFFIX;
...
function lineCreateAgentSession; external TapiDll name 'lineCreateAgentSession'+CODE_SUFFIX;
{$ENDIF}
...
function lineDial; external TapiDll name 'lineDial'+CODE_SUFFIX;
{$ELSE}
...
function lineForward; external TapiDll name 'lineForward'+CODE_SUFFIX;
{$ELSE}
...
function lineGatherDigits; external TapiDll name 'lineGatherDigits'+CODE_SUFFIX;
{$ELSE}
...
function lineGenerateDigits; external TapiDll name 'lineGenerateDigits'+CODE_SUFFIX;
{$ELSE}
...
function lineGetAddressCaps; external TapiDll name 'lineGetAddressCaps'+CODE_SUFFIX;
{$ELSE}
...
function lineGetAddressID; external TapiDll name 'lineGetAddressID'+CODE_SUFFIX;
{$ELSE}
...
function lineGetAddressStatus; external TapiDll name 'lineGetAddressStatus'+CODE_SUFFIX;
{$IFDEF TAPI20}
...
function lineGetAgentActivityList; external TapiDll name 'lineGetAgentActivityList'+CODE_SUFFIX;
...
function lineGetAgentCaps; external TapiDll name 'lineGetAgentCaps'+CODE_SUFFIX;
...
function lineGetAgentGroupList; external TapiDll name 'lineGetAgentGroupList'+CODE_SUFFIX;
{$IFDEF TAPI22}
...
function lineGetAgentStatus; external TapiDll name 'lineGetAgentStatus'+CODE_SUFFIX;
{$ENDIF}
{$IFNDEF TAPI10}
...
function lineGetAppPriority; external TapiDll name 'lineGetAppPriority'+CODE_SUFFIX;
{$ELSE}
...
function lineGetCallInfo; external TapiDll name 'lineGetCallInfo'+CODE_SUFFIX;
{$ELSE}
...
function lineGetCountry; external TapiDll name 'lineGetCountry'+CODE_SUFFIX;
{$ELSE}
...
function lineGetDevCaps; external TapiDll name 'lineGetDevCaps'+CODE_SUFFIX;
{$ELSE}
...
function lineGetDevConfig; external TapiDll name 'lineGetDevConfig'+CODE_SUFFIX;
{$ELSE}
...
function lineGetGroupList; external TapiDll name 'lineGetGroupList'+CODE_SUFFIX;
{$ENDIF}
...
function lineGetIcon; external TapiDll name 'lineGetIcon'+CODE_SUFFIX;
{$ELSE}
...
function lineGetID; external TapiDll name 'lineGetID'+CODE_SUFFIX;
{$ELSE}
...
function lineGetLineDevStatus; external TapiDll name 'lineGetLineDevStatus'+CODE_SUFFIX;
{$ELSE}
...
function lineGetProviderList; external TapiDll name 'lineGetProviderList'+CODE_SUFFIX;
{$ELSE}
...
function lineGetQueueList; external TapiDll name 'lineGetQueueList'+CODE_SUFFIX;
{$ENDIF}
{$IFNDEF TAPI10}
...
function lineGetRequest; external TapiDll name 'lineGetRequest'+CODE_SUFFIX;
{$ELSE}
...
function lineGetTranslateCaps; external TapiDll name 'lineGetTranslateCaps'+CODE_SUFFIX;
{$ELSE}
...
function lineHandoff; external TapiDll name 'lineHandoff'+CODE_SUFFIX;
{$ELSE}
...
function lineInitializeEx; external TapiDll name 'lineInitializeEx'+CODE_SUFFIX;
{$ENDIF}
{$IFNDEF TAPI10}
function lineMakeCallA; external TapiDll name 'lineMakeCallA';
function lineMakeCallW; external TapiDll name 'lineMakeCallW';
function lineMakeCall; external TapiDll name 'lineMakeCall'+CODE_SUFFIX;
{$ELSE}
...
function lineOpen; external TapiDll name 'lineOpen'+CODE_SUFFIX;
{$ELSE}
...
function linePark; external TapiDll name 'linePark'+CODE_SUFFIX;
{$ELSE}
...
function linePickup; external TapiDll name 'linePickup'+CODE_SUFFIX;
{$ELSE}
...
function linePrepareAddToConference; external TapiDll name 'linePrepareAddToConference'+CODE_SUFFIX;
{$ELSE}
...
function lineRedirect; external TapiDll name 'lineRedirect'+CODE_SUFFIX;
{$ELSE}
...
function lineSetAppPriority; external TapiDll name 'lineSetAppPriority'+CODE_SUFFIX;
{$ELSE}
...
function lineSetDevConfig; external TapiDll name 'lineSetDevConfig'+CODE_SUFFIX;
{$ELSE}
...
function lineSetTollList; external TapiDll name 'lineSetTollList'+CODE_SUFFIX;
{$ELSE}
...
function lineSetupConference; external TapiDll name 'lineSetupConference'+CODE_SUFFIX;
{$ELSE}
...
function lineSetupTransfer; external TapiDll name 'lineSetupTransfer'+CODE_SUFFIX;
{$ELSE}
...
function lineTranslateAddress; external TapiDll name 'lineTranslateAddress'+CODE_SUFFIX;
{$ELSE}
...
function lineTranslateDialog; external TapiDll name 'lineTranslateDialog'+CODE_SUFFIX;
{$ELSE}
...
function lineUnpark; external TapiDll name 'lineUnpark'+CODE_SUFFIX;
{$ELSE}
...
function phoneConfigDialog; external TapiDll name 'phoneConfigDialog'+CODE_SUFFIX;
{$ELSE}
...
function phoneGetButtonInfo; external TapiDll name 'phoneGetButtonInfo'+CODE_SUFFIX;
{$ELSE}
...
function phoneGetDevCaps; external TapiDll name 'phoneGetDevCaps'+CODE_SUFFIX;
{$ELSE}
...
function phoneGetIcon; external TapiDll name 'phoneGetIcon'+CODE_SUFFIX;
{$ELSE}
...
function phoneGetID; external TapiDll name 'phoneGetID'+CODE_SUFFIX;
{$ELSE}
...
function phoneGetStatus; external TapiDll name 'phoneGetStatus'+CODE_SUFFIX;
{$ELSE}
...
function phoneInitializeEx; external TapiDll name 'phoneInitializeEx'+CODE_SUFFIX;
{$ENDIF}
...
function phoneSetButtonInfo; external TapiDll name 'phoneSetButtonInfo'+CODE_SUFFIX;
{$ELSE}
...
function tapiGetLocationInfo; external TapiDll name 'tapiGetLocationInfo'+CODE_SUFFIX;
{$ELSE}
...
function tapiRequestMakeCall; external TapiDll name 'tapiRequestMakeCall'+CODE_SUFFIX;
{$ELSE}
...
function tapiRequestMediaCall; external TapiDll name 'tapiRequestMediaCall'+CODE_SUFFIX;
{$ELSE}
