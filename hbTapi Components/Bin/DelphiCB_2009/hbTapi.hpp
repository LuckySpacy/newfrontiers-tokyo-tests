...
// (DO NOT EDIT: machine generated header) 'Hbtapi.pas' rev: 20.00
...
public:
	...
	__property Message;
public:
	/* Exception.Create */ inline __fastcall EhbTapiError(const System::UnicodeString Msg) : Sysutils::Exception(Msg) { }
	/* Exception.CreateFmt */ inline __fastcall EhbTapiError(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size) : Sysutils::Exception(Msg, Args, Args_Size) { }
	...
	/* Exception.CreateHelp */ inline __fastcall EhbTapiError(const System::UnicodeString Msg, int AHelpContext) : Sysutils::Exception(Msg, AHelpContext) { }
	/* Exception.CreateFmtHelp */ inline __fastcall EhbTapiError(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size, int AHelpContext) : Sysutils::Exception(Msg, Args, Args_Size, AHelpContext) { }
...
protected:
	...
	System::UnicodeString __fastcall Get_ButtonText();
...
public:
	...
	System::UnicodeString __fastcall ButtonFunctionText();
	System::UnicodeString __fastcall ButtonModeText();
	System::UnicodeString __fastcall ButtonStateText();
	bool __fastcall IsButton(void);
	bool __fastcall IsLamp(void);
	System::UnicodeString __fastcall LampModeText();
...
typedef StaticArray<System::TObject*, 3> TRequestObjects;
...
protected:
	...
	System::UnicodeString __fastcall DefaultApplName();
...
public:
	...
	unsigned __fastcall Init(System::UnicodeString AppName = L"");
...
protected:
	...
	virtual System::UnicodeString __fastcall Get_DeviceName();
	virtual Classes::TStrings* __fastcall Get_DeviceList(void) = 0 ;
	virtual HICON __fastcall Get_IconHandle(System::UnicodeString DeviceClass = L"");
...
protected:
	...
	System::UnicodeString __fastcall Get_OriginText();
...
public:
	...
	System::UnicodeString __fastcall BusyModeText();
	System::UnicodeString __fastcall ConnectedModeText();
	System::UnicodeString __fastcall DisconnectModeText();
	...
	System::UnicodeString __fastcall OfferingModeText();
	System::UnicodeString __fastcall PrivilegeText(System::UnicodeString Separator = L", ");
	System::UnicodeString __fastcall SpecialInfoModeText();
	System::UnicodeString __fastcall StateModeText();
	System::UnicodeString __fastcall StateText();
	...
	void __fastcall Accept(System::UnicodeString UserUserInfo = L"");
	void __fastcall Answer(System::UnicodeString UserUserInfo = L"");
	void __fastcall ClearNotes(void);
	virtual void __fastcall Deallocate(void);
	void __fastcall Dial(System::UnicodeString DestAddr);
	void __fastcall Drop(System::UnicodeString UserUserInfo = L"");
...
public:
	...
	System::UnicodeString __fastcall TextDump();
	__property bool Available = {read=Get_Available, nodefault};
...
protected:
	...
	System::UnicodeString __fastcall Get_DeviceName();
...
protected:
	...
	bool __fastcall ValidateCall(ThbTapiCall* Call, System::UnicodeString ExceptionText = L"");
...
public:
	...
	virtual void __fastcall Accept(ThbTapiCall* Call, System::UnicodeString UserUserInfo = L"");
	virtual void __fastcall Answer(ThbTapiCall* Call, System::UnicodeString UserUserInfo = L"");
	virtual void __fastcall Drop(ThbTapiCall* Call, System::UnicodeString UserUserInfo = L"");
...
extern PACKAGE System::UnicodeString __fastcall GetTapiBlockStr(void * Block, void * Fields, unsigned StringFormat = (unsigned)(0x0));
extern PACKAGE System::UnicodeString __fastcall TapiStrToAnsi(System::UnicodeString Value, unsigned Len, unsigned StringFormat);
extern PACKAGE System::UnicodeString __fastcall GetTapiErrorMessage(unsigned ErrorCode);
