...
// (DO NOT EDIT: machine generated header) 'hbTapi23.dpk' rev: 30.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_HBTAPI23)
using namespace Hbtapi23;
#endif
#pragma pack(pop)
#pragma option pop
