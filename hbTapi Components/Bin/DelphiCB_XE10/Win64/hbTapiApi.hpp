...
// (DO NOT EDIT: machine generated header) 'hbTapiApi.pas' rev: 30.00 (Windows)
...
typedef void __stdcall (*TLineCallback)(unsigned hDevice, unsigned dwMessage, NativeUInt dwInstance, NativeUInt dwParam1, NativeUInt dwParam2, NativeUInt dwParam3);

typedef void __stdcall (*TPhoneCallback)(unsigned hDevice, unsigned dwMessage, NativeUInt dwInstance, NativeUInt dwParam1, NativeUInt dwParam2, NativeUInt dwParam3);
