...
// (DO NOT EDIT: machine generated header) 'hbComm.pas' rev: 31.00 (Windows)
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EComPortError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EComPortError(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EComPortError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EComPortError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EComPortError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EComPortError(NativeUInt Ident, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High, AHelpContext) { }
...
typedef System::TMetaClass* TComPortErrorClass;
...
public:
	ThbComPortOperation* operator[](int Index) { return this->Items[Index]; }
...
protected:
	...
	__property NativeUInt Handle = {read=FHandle, write=Set_Handle, nodefault};
