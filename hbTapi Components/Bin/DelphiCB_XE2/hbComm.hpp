...
// (DO NOT EDIT: machine generated header) 'hbComm.pas' rev: 23.00 (Win32)
...
public:
	...
	/* Exception.CreateRes */ inline __fastcall EComPortError(int Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	/* Exception.CreateResFmt */ inline __fastcall EComPortError(int Ident, System::TVarRec const *Args, const int Args_Size)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_Size) { }
	...
	/* Exception.CreateResHelp */ inline __fastcall EComPortError(int Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
...
protected:
	...
	void __fastcall SetPicture(bool Index, const Vcl::Graphics::TPicture* Value);
