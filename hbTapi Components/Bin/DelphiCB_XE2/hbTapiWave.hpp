...
// (DO NOT EDIT: machine generated header) 'hbTapiWave.pas' rev: 23.00 (Win32)
...
public:
	...
	/* Exception.CreateRes */ inline __fastcall EWaveError(int Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	/* Exception.CreateResFmt */ inline __fastcall EWaveError(int Ident, System::TVarRec const *Args, const int Args_Size)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_Size) { }
	...
	/* Exception.CreateResHelp */ inline __fastcall EWaveError(int Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
...
protected:
	...
	void __fastcall SetPlayList(const System::Classes::TStrings* Value);
...
public:
	__fastcall TWaveStream(int mmIO, Winapi::Mmsystem::PWaveFormatEx WriteFormat);
