...
// (DO NOT EDIT: machine generated header) 'hbTapiEval.pas' rev: 5.00
...
public:
	...
	/* TCustomForm.CreateNew */ inline __fastcall virtual ThbTapiAboutDialog(Classes::TComponent* AOwner
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall ThbTapiAboutDialog(HWND ParentWindow) : Forms::TForm(
		ParentWindow) { }
	#pragma option pop
