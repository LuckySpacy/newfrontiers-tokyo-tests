...
// (DO NOT EDIT: machine generated header) 'hbTapiUtils.pas' rev: 6.00
...
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
#pragma error Unsupported symbol type (23, hbTapiUtils)
...
extern PACKAGE unsigned __fastcall StrToLineMediaMode(AnsiString MediaMode, unsigned Default = (unsigned)(0x0));
...
extern PACKAGE unsigned __fastcall StrToLineDigitMode(AnsiString DigitMode, unsigned Default = (unsigned)(0x0));
