...
// (DO NOT EDIT: machine generated header) 'hbComm.pas' rev: 22.00
...
public:
	int ErrorCode;
public:
	/* Exception.Create */ inline __fastcall EComPortError(const System::UnicodeString Msg) : Sysutils::Exception(Msg) { }
	/* Exception.CreateFmt */ inline __fastcall EComPortError(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size) : Sysutils::Exception(Msg, Args, Args_Size) { }
	/* Exception.CreateRes */ inline __fastcall EComPortError(int Ident)/* overload */ : Sysutils::Exception(Ident) { }
	/* Exception.CreateResFmt */ inline __fastcall EComPortError(int Ident, System::TVarRec const *Args, const int Args_Size)/* overload */ : Sysutils::Exception(Ident, Args, Args_Size) { }
	/* Exception.CreateHelp */ inline __fastcall EComPortError(const System::UnicodeString Msg, int AHelpContext) : Sysutils::Exception(Msg, AHelpContext) { }
	/* Exception.CreateFmtHelp */ inline __fastcall EComPortError(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size, int AHelpContext) : Sysutils::Exception(Msg, Args, Args_Size, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EComPortError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_Size, int AHelpContext)/* overload */ : Sysutils::Exception(ResStringRec, Args, Args_Size, AHelpContext) { }
...
static const System::ShortInt COMPORTHANDSHAKE_NONE = 0x0;
static const System::ShortInt COMPORTHANDSHAKE_XONXOFF = 0x1;
static const System::ShortInt COMPORTHANDSHAKE_RTSCTS = 0x2;
static const System::ShortInt COMPORTHANDSHAKE_RTSCTS_TOGGLE = 0x4;
static const System::ShortInt COMPORTHANDSHAKE_DTRDSR = 0x8;
static const System::ShortInt COMPORTSIGNAL_NONE = 0x0;
static const System::ShortInt COMPORTSIGNAL_DTR = 0x1;
static const System::ShortInt COMPORTSIGNAL_DSR = 0x2;
static const System::ShortInt COMPORTSIGNAL_RTS = 0x4;
static const System::ShortInt COMPORTSIGNAL_CTS = 0x8;
static const System::ShortInt COMPORTSIGNAL_RING = 0x10;
static const System::ShortInt COMPORTSIGNAL_DCD = 0x20;
static const System::ShortInt COMPORTSIGNAL_TXD = 0x40;
static const System::Byte COMPORTSIGNAL_RXD = 0x80;
static const System::Word COMEVENTS_ALL = 0x1ff;
static const System::Word DEFAULT_READBUFFERSIZE = 0x1000;
static const System::Word DEFAULT_WRITEBUFFERSIZE = 0x1000;
static const int DEFAULT_READTIMEOUT = -1;
static const int DEFAULT_WRITETIMEOUT = -1;
