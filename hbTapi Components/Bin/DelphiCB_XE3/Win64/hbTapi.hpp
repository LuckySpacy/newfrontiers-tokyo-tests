...
// (DO NOT EDIT: machine generated header) 'hbTapi.pas' rev: 24.00 (Win64)
...
public:
	...
	bool __fastcall CompareExtensionID(lineextensionid_tag &value)/* overload */;
	bool __fastcall CompareExtensionID(phoneextensionid_tag &value)/* overload */;
...
public:
	__fastcall ThbTapiLineMsgStackItem(linemessage_tag &LineMsg);
public:
...
public:
	__fastcall ThbTapiPhoneMsgStackItem(linemessage_tag &PhoneMsg);
public:
...
public:
	...
	void __fastcall SetRequestNote(int RequestID, System::UnicodeString Ident, System::Variant &Value);
