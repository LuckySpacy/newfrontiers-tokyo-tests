...
// (DO NOT EDIT: machine generated header) 'hbTapi17.pas' rev: 24.00 (Win32)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_HBTAPI17)
using namespace Hbtapi17;
#endif
#pragma pack(pop)
#pragma option pop
