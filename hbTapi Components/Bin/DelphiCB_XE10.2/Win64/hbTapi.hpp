...
// (DO NOT EDIT: machine generated header) 'hbTapi.pas' rev: 32.00 (Windows)
...
//-- type declarations -------------------------------------------------------
_DECLARE_METACLASS(System::TMetaClass, ThbTapiCallClass);
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EhbTapiError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EhbTapiError(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EhbTapiError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EhbTapiError(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EhbTapiError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EhbTapiError(NativeUInt Ident, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High, AHelpContext) { }
...
public:
	ThbCustomTapiLine* operator[](int Index) { return this->Items[Index]; }
...
public:
	ThbCustomTapiPhone* operator[](int Index) { return this->Items[Index]; }
...
public:
	ThbTapiCall* operator[](int Index) { return this->Items[Index]; }
...
public:
	ThbTapiPhoneControl* operator[](int Index) { return this->Items[Index]; }
...
public:
	ThbTapiRequest* operator[](int Index) { return this->Items[Index]; }
...
public:
	ThbTapiDevSpecificData* operator[](int Index) { return this->Items[Index]; }
...
public:
	ThbTapiMsgStackItem* operator[](int Index) { return this->Items[Index]; }
...
protected:
	...
	NativeUInt __fastcall NewCallbackInstance(void);
...
protected:
	...
	__property NativeUInt CallbackInstance = {read=FCallbackInstance};
...
public:
	ThbTapiForward* operator[](int Index) { return this->Items[Index]; }
...
public:
	ThbTapiAddress* operator[](int Index) { return this->Items[Index]; }
...
public:
	...
	__property NativeUInt Handle = {read=Get_Handle};
...
public:
	...
	virtual void __fastcall ConfigDialog(HWND OwnerWnd = (HWND)(0ULL));
	...
	virtual void __fastcall TranslateDialog(System::UnicodeString Address, HWND OwnerWnd = (HWND)(0ULL));
...
public:
	ThbTapiLocation* operator[](int Index) { return this->Items[Index]; }
