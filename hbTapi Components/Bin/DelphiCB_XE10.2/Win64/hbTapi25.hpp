...
// (DO NOT EDIT: machine generated header) 'hbTapi25.dpk' rev: 32.00 (Windows)
...
#include <hbTapiApi.hpp>	// (<weak>)
#include <Winapi.MMSystem.hpp>	// (rtl)
// PRG_EXT: .bpl
// BPI_DIR: D:\hbTapi\Bin\Evaluation\BCB25\Win64
// OBJ_DIR: D:\hbTapi\Bin\Evaluation\BCB25\Win64
// OBJ_EXT: .o
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_HBTAPI25)
using namespace Hbtapi25;
#endif
#pragma pack(pop)
#pragma option pop
