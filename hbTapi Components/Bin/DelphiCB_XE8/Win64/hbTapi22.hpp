...
// (DO NOT EDIT: machine generated header) 'hbTapi22.dpk' rev: 29.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_HBTAPI22)
using namespace Hbtapi22;
#endif
#pragma pack(pop)
#pragma option pop
