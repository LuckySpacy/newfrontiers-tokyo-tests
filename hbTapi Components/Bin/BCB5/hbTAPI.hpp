...
// (DO NOT EDIT: machine generated header) 'hbTapi.pas' rev: 5.00
...
public:
	bool __fastcall Acquire(unsigned Timeout);
...
public:
	...
	void __fastcall Assign(ThbTapiCallList* Value);
...
typedef void __fastcall (__closure *ThbTapiErrorEvent)(System::TObject* Sender, Sysutils::Exception* 
	Error, System::TObject* Causer);
...
typedef void __fastcall (__closure *ThbTapiDeviceNameEvent)(System::TObject* Sender, unsigned DeviceID
	, AnsiString DeviceName);

typedef void __fastcall (__closure *ThbTapiRequestMakeCallEvent)(System::TObject* Sender, AnsiString 
	DestAddress, AnsiString AppName, AnsiString CalledParty, AnsiString Comment);

typedef void __fastcall (__closure *ThbTapiDetailedMessageEvent)(System::TObject* Sender, unsigned MessageID
	, unsigned Device, unsigned CallbackInstance, unsigned Param1, unsigned Param2, unsigned Param3);
...
private:
	...
	void __fastcall Update_LineDevices(bool TriggerRenaming);
	void __fastcall Update_PhoneDevice(int DeviceID);
	void __fastcall Update_PhoneDevices(bool TriggerRenaming);
...
protected:
	...
	virtual void __fastcall Handle_Exception(System::TObject* Sender, Sysutils::Exception* Error, System::TObject* 
		Causer)/* overload */;
	...
	virtual void __fastcall Trigger_TapiMessage(unsigned MessageID, unsigned Device, unsigned CallbackInstance
		, unsigned Param1, unsigned Param2, unsigned Param3);
	bool __fastcall IsActive(void);
	AnsiString __fastcall DefaultApplName(void);
	...
	int __fastcall ProcessTapiMessages(int MaxMessages);
	void __fastcall WindowProc(Messages::TMessage &Message);
	void __fastcall TimerEventProc(unsigned TickCount);
...
protected:
	...
	virtual void __fastcall Handle_Exception(Sysutils::Exception* Error, System::TObject* Causer);
...
public:
	...
	int __fastcall IndexOfRequest(unsigned ID, unsigned RequestType, System::TObject* Obj);
	void __fastcall RemoveAllRequests(System::TObject* Target);
};
...
public:
	#pragma option push -w-inl
	/* ThbTapiRelatedDevice.Create */ inline __fastcall ThbTapiRelatedWaveDevice(System::TObject* AOwner
		, AnsiString AClass) : ThbTapiRelatedDevice(AOwner, AClass) { }
	#pragma option pop
	#pragma option push -w-inl
...
typedef void __fastcall (__closure *ThbTapiDeviceStateEvent)(System::TObject* Sender, unsigned State
	, unsigned StateDetail1, unsigned StateDetail2);

typedef void __fastcall (__closure *ThbTapiMessageEvent)(System::TObject* Sender, unsigned MessageID
	, unsigned Device, unsigned Param1, unsigned Param2, unsigned Param3);

typedef void __fastcall (__closure *ThbTapiReplyEvent)(System::TObject* Sender, unsigned RequestID, 
	unsigned ReplyCode);
...
protected:
	...
	virtual bool __fastcall Get_Available(void);
	void __fastcall Process_TapiMessage(unsigned Device, unsigned Msg, unsigned Param1, unsigned Param2
		, unsigned Param3);
	...
	virtual void __fastcall Handle_TapiMessage(unsigned MessageID, unsigned Device, unsigned Param1, unsigned 
		Param2, unsigned Param3);
	virtual void __fastcall Handle_DeviceState(unsigned DeviceState, unsigned DeviceStateDetail1, unsigned 
		DeviceStateDetail2);
	...
	virtual void __fastcall Trigger_DeviceState(unsigned DeviceState, unsigned DeviceStateDetail1, unsigned 
		DeviceStateDetail2);
	virtual void __fastcall Trigger_TapiMessage(unsigned MessageID, unsigned Device, unsigned Param1, unsigned 
		Param2, unsigned Param3);
	...
	virtual AnsiString __fastcall Get_DeviceName(void);
...
protected:
	...
	AnsiString __fastcall Get_Text(void);
...
typedef void __fastcall (__closure *ThbTapiAddressStateEvent)(ThbTapiLine* Sender, ThbTapiAddress* Address
	, unsigned AddressState);

typedef void __fastcall (__closure *ThbTapiAddrEvent)(ThbTapiLine* Sender, ThbTapiAddress* Addr, unsigned 
	AddressState);

typedef void __fastcall (__closure *ThbTapiCallDigitEvent)(ThbTapiLine* Sender, ThbTapiCall* Call, char 
	Digit);

typedef void __fastcall (__closure *ThbTapiCallEvent)(ThbTapiLine* Sender, ThbTapiCall* Call);

typedef void __fastcall (__closure *ThbTapiCallGatherDigitsEvent)(ThbTapiLine* Sender, ThbTapiCall* 
	Call, AnsiString Digits, unsigned Termination);

typedef void __fastcall (__closure *ThbTapiCallGenerateEvent)(ThbTapiLine* Sender, ThbTapiCall* Call
	, unsigned GenerateTermination);

typedef void __fastcall (__closure *ThbTapiCallInfoEvent)(ThbTapiLine* Sender, ThbTapiCall* Call, unsigned 
	InfoState);

typedef void __fastcall (__closure *ThbTapiCallPrivilegeEvent)(ThbTapiLine* Sender, ThbTapiCall* Call
	, unsigned CallPrivilege);

typedef void __fastcall (__closure *ThbTapiCallStateEvent)(ThbTapiLine* Sender, ThbTapiCall* Call, unsigned 
	CallState);

typedef void __fastcall (__closure *ThbTapiCallStateModeEvent)(ThbTapiLine* Sender, ThbTapiCall* Call
	, unsigned StateMode);

typedef void __fastcall (__closure *ThbTapiCallToneEvent)(ThbTapiLine* Sender, ThbTapiCall* Call, unsigned 
	AppSpecific);

typedef void __fastcall (__closure *ThbTapiDeviceEvent)(System::TObject* Sender, unsigned DeviceID);
	

typedef void __fastcall (__closure *ThbTapiLineDevSpecificEvent)(ThbTapiLine* Sender, ThbTapiCall* Call
	, unsigned DeviceSpecific1, unsigned DeviceSpecific2, unsigned DeviceSpecific3);

typedef void __fastcall (__closure *ThbTapiLineDevSpecReplyEvent)(System::TObject* Sender, unsigned 
	RequestID, void * Data, unsigned DataSize, ThbTapiAddress* Address, ThbTapiCall* Call, unsigned ReplyCode
	);

typedef void __fastcall (__closure *ThbTapiLineDevSpecTimeoutEvent)(System::TObject* Sender, unsigned 
	RequestID, void * Data, unsigned DataSize, ThbTapiAddress* Address, ThbTapiCall* Call, unsigned ElapsedTime
	);

typedef void __fastcall (__closure *ThbTapiLineRingEvent)(ThbTapiLine* Sender, unsigned RingMode, unsigned 
	RingCount);

class DELPHICLASS ThbTapiPhone;
typedef void __fastcall (__closure *ThbTapiPhoneButtonEvent)(ThbTapiPhone* Sender, unsigned ButtonID
	, unsigned ButtonMode, unsigned ButtonState);

typedef void __fastcall (__closure *ThbTapiPhoneButtonLampEvent)(ThbTapiPhone* Sender, unsigned ButtonLampID
	);

typedef void __fastcall (__closure *ThbTapiPhoneDevSpecificEvent)(ThbTapiPhone* Sender, unsigned DeviceSpecific1
	, unsigned DeviceSpecific2, unsigned DeviceSpecific3);

typedef void __fastcall (__closure *ThbTapiPhoneDigitEvent)(ThbTapiPhone* Sender, char Digit);

typedef void __fastcall (__closure *ThbTapiDevSpecReplyEvent)(System::TObject* Sender, unsigned RequestID
	, void * Data, unsigned DataSize, unsigned ReplyCode);

typedef void __fastcall (__closure *ThbTapiDevSpecTimeoutEvent)(System::TObject* Sender, unsigned RequestID
	, void * Data, unsigned DataSize, unsigned ElapsedTime);
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EhbTapiError(const AnsiString Msg, const System::TVarRec 
		* Args, const int Args_Size) : Sysutils::Exception(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EhbTapiError(int Ident)/* overload */ : Sysutils::Exception(
		Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EhbTapiError(int Ident, const System::TVarRec * Args
		, const int Args_Size)/* overload */ : Sysutils::Exception(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall EhbTapiError(const AnsiString Msg, int AHelpContext) : 
		Sysutils::Exception(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EhbTapiError(const AnsiString Msg, const System::TVarRec 
		* Args, const int Args_Size, int AHelpContext) : Sysutils::Exception(Msg, Args, Args_Size, AHelpContext
		) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResHelp */ inline __fastcall EhbTapiError(int Ident, int AHelpContext)/* overload */
		 : Sysutils::Exception(Ident, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EhbTapiError(System::PResStringRec ResStringRec, 
...
public:
	#pragma option push -w-inl
	/* ThbTapiTSP.Create */ inline __fastcall ThbTapiPhoneTSP(ThbTapiDevice* ATapiDevice) : ThbTapiTSP(
		ATapiDevice) { }
	#pragma option pop
...
protected:
	...
	AnsiString __fastcall Get_ButtonText(void);
...
public:
	...
	AnsiString __fastcall ButtonFunctionText(void);
	AnsiString __fastcall ButtonModeText(void);
	AnsiString __fastcall ButtonStateText(void);
	bool __fastcall IsButton(void);
	bool __fastcall IsLamp(void);
	AnsiString __fastcall LampModeText(void);
...
public:
	#pragma option push -w-inl
	/* ThbTapiDevSpecificData.Create */ inline __fastcall ThbTapiLineDevSpecificData(void * Data, unsigned 
		DataSize) : ThbTapiDevSpecificData(Data, DataSize) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* ThbTapiDevSpecificData.Create */ inline __fastcall ThbTapiLineDevSpecificFeatureData(void * Data
		, unsigned DataSize) : ThbTapiDevSpecificData(Data, DataSize) { }
	#pragma option pop
	#pragma option push -w-inl
...
protected:
	virtual AnsiString __fastcall Get_Address(void);
	virtual unsigned __fastcall Get_Flags(void);
	virtual AnsiString __fastcall Get_Name(void);
...
protected:
	...
	AnsiString __fastcall Get_DeviceName(void);
...
public:
	#pragma option push -w-inl
	/* ThbTapiRelatedDevice.Create */ inline __fastcall ThbTapiCommDevice(System::TObject* AOwner, AnsiString 
		AClass) : ThbTapiRelatedDevice(AOwner, AClass) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* ThbTapiCallBasicPartyID.Create */ inline __fastcall ThbTapiCallRemoteID(ThbTapiCall* AOwner) : ThbTapiCallBasicPartyID(
		AOwner) { }
	#pragma option pop
...
protected:
	...
	AnsiString __fastcall Get_OriginText(void);
...
public:
	...
	AnsiString __fastcall BusyModeText(void);
	AnsiString __fastcall ConnectedModeText(void);
	AnsiString __fastcall DisconnectModeText(void);
	...
	AnsiString __fastcall OfferingModeText(void);
	AnsiString __fastcall PrivilegeText(AnsiString Separator = ", ");
	AnsiString __fastcall SpecialInfoModeText(void);
	AnsiString __fastcall StateModeText(void);
	AnsiString __fastcall StateText(void);
	...
	__property ThbTapiRelatedWaveDevice* WaveIn = {read=FWaveInDev};
	__property ThbTapiRelatedWaveDevice* WaveOut = {read=FWaveOutDev};
	ThbTapiCall* __fastcall CompleteTransfer(bool BuildConf);
	void __fastcall HandOff(AnsiString FileName);
	void __fastcall Hold(void);
	void __fastcall SwapHold(ThbTapiCall* Call);
	...
	void __fastcall MonitorTone(unsigned Frequency1, unsigned Frequency2, unsigned Frequency3, unsigned 
		Duration, unsigned AppSpecific);
...
public:
	#pragma option push -w-inl
	/* ThbTapiCallBasicPartyID.Create */ inline __fastcall ThbTapiCallStoredRemoteID(ThbTapiCall* AOwner
		) : ThbTapiCallRemoteID(AOwner) { }
	#pragma option pop
...
public:
	...
	virtual void __fastcall Update(void);
	virtual void __fastcall Invalidate(void);
	AnsiString __fastcall TextDump(void);
	__property bool Available = {read=Get_Available, nodefault};
...
public:
	...
	ThbTapiForward* __fastcall AddEntry(unsigned ForwardMode, AnsiString CallerAddress, unsigned DestCountryCode
		, AnsiString DestAddress);
...
public:
	#pragma option push -w-inl
	/* ThbTapiRelatedDevice.Create */ inline __fastcall ThbTapiPhoneLineDevice(System::TObject* AOwner, 
		AnsiString AClass) : ThbTapiRelatedDevice(AOwner, AClass) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* ThbTapiRelatedDevice.Create */ inline __fastcall ThbTapiLinePhoneDevices(System::TObject* AOwner
		, AnsiString AClass) : ThbTapiRelatedDevice(AOwner, AClass) { }
	#pragma option pop
	#pragma option push -w-inl
...
__published:
	__property AddressID ;
	__property BearerMode ;
	__property BlockID ;
	__property Flags ;
	__property MediaMode ;
	__property NoAnswerTimeout ;
public:
	#pragma option push -w-inl
...
protected:
	...
	virtual void __fastcall Handle_CallState(unsigned Call, unsigned State, unsigned CallStateDetail, unsigned 
		CallPrivilege);
	virtual void __fastcall Handle_CallInfo(unsigned Call, unsigned InfoState);
	virtual void __fastcall Handle_DeviceState(unsigned DeviceState, unsigned DeviceStateDetail1, unsigned 
		DeviceStateDetail2);
	virtual void __fastcall Handle_DevSpecific(unsigned LineOrCall, unsigned DeviceSpecific1, unsigned 
		DeviceSpecific2, unsigned DeviceSpecific3);
	virtual void __fastcall Handle_DevSpecFeature(unsigned LineOrCall, unsigned DeviceSpecific1, unsigned 
		DeviceSpecific2, unsigned DeviceSpecific3);
	...
	virtual void __fastcall Handle_TapiMessage(unsigned Device, unsigned Msg, unsigned Param1, unsigned 
		Param2, unsigned Param3);
	virtual void __fastcall Handle_Timeout(unsigned RequestID, ThbTapiRequest* Request);
	virtual void __fastcall Handle_Timer(unsigned RequestID, ThbTapiRequest* Request);
	...
	virtual void __fastcall Trigger_CallState(ThbTapiCall* Call, unsigned State, unsigned StateDetail, 
		unsigned Privilege);
	virtual void __fastcall Trigger_DeallocateCall(ThbTapiCall* Call);
	virtual void __fastcall Trigger_DeviceState(unsigned DeviceState, unsigned DeviceStateDetail1, unsigned 
		DeviceStateDetail2);
	virtual void __fastcall Trigger_DevSpecific(ThbTapiCall* Call, unsigned DeviceSpecific1, unsigned DeviceSpecific2
		, unsigned DeviceSpecific3);
	virtual void __fastcall Trigger_DevSpecificFeature(ThbTapiCall* Call, unsigned DeviceSpecific1, unsigned 
		DeviceSpecific2, unsigned DeviceSpecific3);
	virtual void __fastcall Trigger_DevSpecificReply(unsigned RequestID, ThbTapiDevSpecificData* DevSpecData
		, unsigned ReplyCode);
	virtual void __fastcall Trigger_DevSpecificTimeout(unsigned RequestID, ThbTapiDevSpecificData* DevSpecData
		, unsigned ElapsedTime);
	virtual void __fastcall Trigger_DevSpecificFeatureReply(unsigned RequestID, unsigned Feature, ThbTapiDevSpecificData* 
		DevSpecData, unsigned ReplyCode);
	virtual void __fastcall Trigger_DevSpecificFeatureTimeout(unsigned RequestID, unsigned Feature, ThbTapiDevSpecificData* 
		DevSpecData, unsigned ElapsedTime);
	...
	unsigned __fastcall OpenLine(unsigned CallbackInstance, Hbtapiapi::PLineCallParams CallParams)/* overload */
		;
	ThbTapiCall* __fastcall FindProperCall(unsigned CallStates, unsigned CallFeatures, int AddressID, ThbTapiCall* 
		ExcludeCall);
	ThbTapiCall* __fastcall GetCallByHandle(unsigned Call, bool AllowCreation);
...
public:
	...
	virtual ThbTapiCall* __fastcall MakeCall(AnsiString DestAddr, unsigned CountryCode, Hbtapiapi::PLineCallParams 
		CallParams)/* overload */;
	virtual void __fastcall Dial(ThbTapiCall* Call, AnsiString DestAddr, unsigned CountryCode);
	virtual AnsiString __fastcall TranslateAddress(AnsiString Address, unsigned Options);
	...
	virtual ThbTapiCall* __fastcall CompleteTransfer(ThbTapiCall* Call, ThbTapiCall* ConsultCall, unsigned 
		TransferMode);
	...
	virtual void __fastcall BlindTransfer(ThbTapiCall* Call, AnsiString DestAddr, unsigned CountryCode)
		;
	virtual void __fastcall CompleteCall(ThbTapiCall* Call, unsigned &CompletionID, unsigned CompletionMode
		, unsigned MessageID);
	virtual void __fastcall ConfigDialog(HWND OwnerWnd);
	virtual void __fastcall ForwardAddress(ThbTapiAddress* Address, Hbtapiapi::PLineForwardList ForwardList
		, unsigned NumRingsNoAnswer, unsigned &ConsultCallHandle, Hbtapiapi::PLineCallParams CallParams);
	virtual void __fastcall GenerateDigits(ThbTapiCall* Call, AnsiString Digits, unsigned DigitMode, unsigned 
		Duration);
	...
	virtual void __fastcall Park(ThbTapiCall* Call, unsigned ParkMode, AnsiString DirAddress, Hbtapiapi::PVarString 
		NonDirAddress);
	virtual void __fastcall SwapHold(ThbTapiCall* Call, ThbTapiCall* HeldCall);
	virtual void __fastcall TranslateDialog(AnsiString Address, HWND OwnerWnd);
	...
	virtual ThbTapiCall* __fastcall PrepareAddToConference(ThbTapiCall* ConfCall, Hbtapiapi::PLineCallParams 
		CallParams);
	virtual void __fastcall AddToConference(ThbTapiCall* ConfCall, ThbTapiCall* ConsultCall);
	virtual void __fastcall DevSpecific(void * Params, unsigned Size, ThbTapiAddress* Address, ThbTapiCall* 
		Call);
	virtual void __fastcall DevSpecificFeature(unsigned Feature, void * Params, unsigned Size);
	virtual void __fastcall GenerateTone(ThbTapiCall* Call, unsigned ToneMode, unsigned Duration, unsigned 
		NumTones, Hbtapiapi::PLineGenerateTone Tones);
	virtual void __fastcall MonitorMedia(ThbTapiCall* Call, unsigned MediaModes);
	virtual void __fastcall MonitorTones(ThbTapiCall* Call, Hbtapiapi::PLineMonitorTone ToneList, unsigned 
		NumEntries);
	...
	virtual void __fastcall SetupConference(ThbTapiCall* Call, ThbTapiCall* &ConfCall, ThbTapiCall* &ConsultCall
		, unsigned NumParties, Hbtapiapi::PLineCallParams CallParams);
	__property unsigned Handle = {read=Get_Handle, nodefault};
	...
	__property unsigned AddressStateMessages = {read=Get_AddressStateMessages, write=Set_AddressStateMessages
		, nodefault};
};
...
__published:
	...
	__property ThbTapiLineDevSpecTimeoutEvent OnDevSpecificTimeout = {read=FOnDevSpecificTimeout, write=
		FOnDevSpecificTimeout};
	__property OnTapiMessage ;
public:
	#pragma option push -w-inl
	/* ThbCustomTapiLine.Create */ inline __fastcall virtual ThbTapiLine(Classes::TComponent* AOwner) : 
		ThbCustomTapiLine(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
protected:
	...
	virtual void __fastcall Handle_Button(unsigned ButtonID, unsigned ButtonMode, unsigned ButtonState)
		;
	virtual void __fastcall Handle_DevSpecific(unsigned DeviceSpecific1, unsigned DeviceSpecific2, unsigned 
		DeviceSpecific3);
	virtual void __fastcall Handle_Reply(unsigned RequestID, unsigned ReplyCode, ThbTapiRequest* Request
		);
	virtual void __fastcall Handle_Timeout(unsigned RequestID, ThbTapiRequest* Request);
	...
	virtual void __fastcall Trigger_DevSpecific(unsigned DeviceSpecific1, unsigned DeviceSpecific2, unsigned 
		DeviceSpecific3);
	virtual void __fastcall Trigger_DevSpecificReply(unsigned RequestID, ThbTapiDevSpecificData* DevSpecData
		, unsigned ReplyCode);
	virtual void __fastcall Trigger_DevSpecificTimeout(unsigned RequestID, ThbTapiDevSpecificData* DevSpecData
...
public:
	...
	__property unsigned PhoneStateMessages = {read=Get_PhoneStateMessages, write=Set_PhoneStateMessages
		, nodefault};
	__property unsigned ButtonStateMessages = {read=Get_ButtonStateMessages, write=Set_ButtonStateMessages
		, nodefault};
	__property unsigned ButtonModeMessages = {read=Get_ButtonModeMessages, write=Set_ButtonModeMessages
		, nodefault};
};
...
__published:
	...
	__property Classes::TNotifyEvent OnSpeakerphoneHookSwitch = {read=FOnState_SpeakerHookSwitch, write=
		FOnState_SpeakerHookSwitch};
...
public:
	#pragma option push -w-inl
	/* ThbCustomTapiPhone.Create */ inline __fastcall virtual ThbTapiPhone(Classes::TComponent* AOwner)
		 : ThbCustomTapiPhone(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
protected:
	...
	void __fastcall Handle_Reply(unsigned RequestID, unsigned ReplyCode, ThbTapiRequest* Request);
	AnsiString __fastcall Get_Address(void);
...
public:
	...
	__property int Tag = {read=FTag, write=FTag, nodefault};
	void __fastcall ChangeForwardList(ThbTapiForwardList* ForwardList, unsigned NumRingsNoAnswer, ThbTapiCallParams* 
		CallParams);
...
extern PACKAGE AnsiString __fastcall GetTapiBlockStr(void * Block, void * Fields, unsigned StringFormat
	);
