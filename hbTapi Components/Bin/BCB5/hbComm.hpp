...
// (DO NOT EDIT: machine generated header) 'hbComm.pas' rev: 5.00
...
public:
	...
	/* Exception.Create */ inline __fastcall EComPortError(const AnsiString Msg) : Sysutils::Exception(
		Msg) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EComPortError(const AnsiString Msg, const System::TVarRec 
		* Args, const int Args_Size) : Sysutils::Exception(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EComPortError(int Ident)/* overload */ : Sysutils::Exception(
		Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EComPortError(int Ident, const System::TVarRec * Args
		, const int Args_Size)/* overload */ : Sysutils::Exception(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall EComPortError(const AnsiString Msg, int AHelpContext) : 
		Sysutils::Exception(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EComPortError(const AnsiString Msg, const System::TVarRec 
		* Args, const int Args_Size, int AHelpContext) : Sysutils::Exception(Msg, Args, Args_Size, AHelpContext
		) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResHelp */ inline __fastcall EComPortError(int Ident, int AHelpContext)/* overload */
		 : Sysutils::Exception(Ident, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EComPortError(System::PResStringRec ResStringRec
...
protected:
	...
	AnsiString __fastcall Get_Settings(void);
...
public:
	...
	AnsiString __fastcall ReadStr(void)/* overload */;
	AnsiString __fastcall ReadStr(int Count)/* overload */;
	AnsiString __fastcall ReadAnsiStr(void)/* overload */;
...
public:
	#pragma option push -w-inl
	/* ThbCustomComPort.Create */ inline __fastcall virtual ThbComPort(Classes::TComponent* AOwner) : ThbCustomComPort(
		AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
