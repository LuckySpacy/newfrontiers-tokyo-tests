...
// (DO NOT EDIT: machine generated header) 'hbTapi20.dpk' rev: 27.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_HBTAPI20)
using namespace Hbtapi20;
#endif
#pragma pack(pop)
#pragma option pop
