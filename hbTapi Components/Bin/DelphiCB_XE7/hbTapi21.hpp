...
// (DO NOT EDIT: machine generated header) 'hbTapi21.dpk' rev: 28.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_HBTAPI21)
using namespace Hbtapi21;
#endif
#pragma pack(pop)
#pragma option pop
