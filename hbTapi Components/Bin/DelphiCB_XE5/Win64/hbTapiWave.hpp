...
// (DO NOT EDIT: machine generated header) 'hbTapiWave.pas' rev: 26.00 (Windows)
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EWaveError(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size) : System::Sysutils::Exception(Msg, Args, Args_Size) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EWaveError(NativeUInt Ident, System::TVarRec const *Args, const int Args_Size)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_Size) { }
	/* Exception.CreateResFmt */ inline __fastcall EWaveError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_Size)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_Size) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EWaveError(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_Size, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EWaveError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_Size, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_Size, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EWaveError(NativeUInt Ident, System::TVarRec const *Args, const int Args_Size, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_Size, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EWaveIOError(NativeUInt Ident, System::TVarRec const *Args, const int Args_Size)/* overload */ : EWaveError(Ident, Args, Args_Size) { }
	/* Exception.CreateResFmt */ inline __fastcall EWaveIOError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_Size)/* overload */ : EWaveError(ResStringRec, Args, Args_Size) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EWaveIOError(NativeUInt Ident, System::TVarRec const *Args, const int Args_Size, int AHelpContext)/* overload */ : EWaveError(Ident, Args, Args_Size, AHelpContext) { }
