...
// (DO NOT EDIT: machine generated header) 'hbTapi18.pas' rev: 25.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_HBTAPI18)
using namespace Hbtapi18;
#endif
#pragma pack(pop)
#pragma option pop
